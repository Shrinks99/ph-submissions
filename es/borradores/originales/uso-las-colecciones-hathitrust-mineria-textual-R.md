...
2. Crear una cuenta como usuario invitado siguiendo el enlace [“See options to log in as guest”](https://babel.hathitrust.org/cgi/wayf?) que aparece en el mensaje. Esa es la opción que usaremos en este tutorial.
