...
3. Dans l'interface de GitLab.com, ou [en suivant ce lien](https://gitlab.com/projects/new), choisissez l'option «&nbsp;Créer un projet vide&nbsp;», dans lequel vous hébergerez par la suite du code source. 
...
[^7]: [Techniquement, Software Heritage peut archiver des exécutables](https://www.softwareheritage.org/faq/#26_Do_you_also_archive_software_executables_aka_binaries), mais insistons sur le fait qu'il ne s'agit alors que d'un effet secondaire dans l'hébergement du logiciel dans son ensemble. La priorité est la collecte du code source. 
